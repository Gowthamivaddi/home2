...
<!-- Mirrored from themeforest.kreativdev.com/treats/demo/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2023 09:59:05 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                ...
                if ($result->num_rows > 0) {
                    while ($product = $result->fetch_assoc()) {
                        echo '<div class="col-sm-6 col-lg-4 col-xl-3 item">';
                        echo '<div class="product radius-md text-center p-30 mb-25">';
                        echo '<figure class="product-img mb-20 mx-auto">';
                        echo '<a href="shop-details.html" target="_self" title="' . $product['name'] . '" class="lazy-container ratio ratio-1-1 bg-none">';
                        echo '<img class="lazyload" src="assets/images/placeholder.png" data-src="assets/images/product/juice/pro-' . $product['id'] . '.png" alt="' . $product['name'] . '">';
                        echo '</a>';
                        echo '<div class="hover-show">';
                        echo '<div class="btn-groups">';
                        echo '<a href="shop-details.html" class="btn-icon rounded-circle" title="Quick View" target="_self">';
                        echo '<i class="fal fa-eye"></i>';
                        echo '</a>';
                        //echo '<a href="cart.php" class="btn-icon rounded-circle" title="Add to Cart" target="_self">';
                        //echo '<i class="fal fa-shopping-cart"></i>';
                        echo '<form action="cart.php" method="post">';
            echo '<input type="hidden" name="product_id" value="' . $product['id'] . '">';
            echo '<button type="submit" name="add_to_cart" class="btn-icon rounded-circle" title="Add to Cart">';
            echo '<i class="fal fa-shopping-cart"></i>';
            echo '</button>';
            echo '</form>';
                        echo '</a>';
                        echo '<a href="wishlist.php" class="btn-icon rounded-circle" title="Add to Wishlist" target="_self">';
                        ...
                        echo '<h4 class="product-title lc-1 mb-10"><a href="shop-details.html" target="_self" title="' . $product['name'] . '">' . $product['name'] . '</a></h4>';
                        echo '<div class="product-price">';
                        echo '<span class="h6 font-lg new-price color-primary">$' . $product['price'] . '</span>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
